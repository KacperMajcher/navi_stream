...
mixin _$ChannelsState {
  ...
  List<ChannelModel> get channelModel => throw _privateConstructorUsedError;
...
abstract class $ChannelsStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({Status status, List<ChannelModel> channelModel});
}
    ...
    return _then(_value.copyWith(
      status: null == status
          ...
          : status // ignore: cast_nullable_to_non_nullable
              as Status,
      channelModel: null == channelModel
          ? _value.channelModel
...
class _$ChannelsStateImpl implements _ChannelsState {
  const _$ChannelsStateImpl(
      ...
      final List<ChannelModel> channelModel = const []})
  ...
  @JsonKey()
  final Status status;
  final List<ChannelModel> _channelModel;
  @override
  @JsonKey()
  List<ChannelModel> get channelModel {
    if (_channelModel is EqualUnmodifiableListView) return _channelModel;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_channelModel);
  }

  @override
  String toString() {
    return 'ChannelsState(status: $status, channelModel: $channelModel)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._channelModel, _channelModel));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(
      runtimeType, status, const DeepCollectionEquality().hash(_channelModel));
...
abstract class _ChannelsState implements ChannelsState {
  const factory _ChannelsState(
      {final Status status,
      final List<ChannelModel> channelModel}) = _$ChannelsStateImpl;
