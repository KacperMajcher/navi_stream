  ...
  group(
    ...
    () {
      ...
      group(
        ...
        () {
          test(
            'should correctly instantiate with non-null values',
            () {
          ...
          test(
            'should correctly instantiate with null optional values',
            () {
      ...
      group(
        ...
        () {
          test(
            'should serialize to JSON with optional fields',
            () {
          ...
          test(
            'should serialize to JSON with null field',
            () {
          ...
          test(
            'should deserialize from JSON with optional fields',
            () {
          ...
          test(
            'should deserialize from JSON with null field',
            () {
              final result = PackageModel.fromJson(json);
